...
# step 4 - place the PDF file you wish to put a watermark on next to your main Python file
# step 5 - now start coding

import aspose.pdf as ap

document = ap.Document("name of the pdf file you put next to your main file.pdf")
